...
$(document).ready(function() {
    $(".tablas").on("click", ".btnImprimirTicket", function() {
        ...
        if (texto !== null) {
            $.ajax({
                type: "POST",
                url: "C:/xampp/htdocs/sis_inventario/extensiones/tcpdf/pdf/actualizar_observacion.php",
                data: { texto_adicional: texto }, // Envía el texto de observación al script PHP
                success: function(response) {
                    alert("Observación actualizada correctamente en la factura.");
                    // Puedes agregar aquí un código para abrir la factura PDF en una nueva ventana o pestaña
                },
                error: function(xhr, status, error) {
                    alert("Error al actualizar la observación en la factura.");
